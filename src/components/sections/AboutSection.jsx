...
export default function AboutSection() {
  ...
  const iconWrapper =
    "flex-shrink-0 w-16 h-16 rounded-xl bg-white flex items-center justify-center shadow-md ring-1 ring-gray-100";
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-start">
        <div className="animate-fade-in-up space-y-10">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            ...
            React, Node.js, and Flutter, evolving into a solution architect with expertise in fintech, cloud infrastructure, and scalable mobile applications.
            His leadership ensures that STAC Ltd remains at the forefront of innovation, offering secure, user-friendly, and future-ready platforms.
          </p>
        ...
        <div className="bg-gradient-to-br from-white/80 to-red-50/60 backdrop-blur-sm hover:shadow-2xl transform transition duration-300 hover:-translate-y-1 rounded-3xl p-10 animate-fade-in-up space-y-8 ring-1 ring-gray-100">
          ...
          <div className="flex justify-center">
            {founders.map((founder, idx) => (
              <div key={idx} className="text-center max-w-xs">
                ...
                <h4 className="font-semibold text-lg text-gray-900 mt-4">
                  {founder.name}
                </h4>
