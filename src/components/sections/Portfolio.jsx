...
export default function Portfolio() {
  const items = [
    { src: "/Images/network.jpg", title: "Network Solutions" },
    { src: "/Images/Cloud.jpg", title: "Cloud Services" },
    { src: "/Images/POS.png", title: "Custom Software" },
    { src: "/Images/Infrastructure.jpg", title: "Infrastructure" },
    { src: "/Images/Cyber.jpg", title: "Cyber Security" },
    { src: "/Images/IT.jpg", title: "IT Consulting" },
  ];

  return (
    <section id="portfolio" className="py-28 px-6 relative overflow-hidden">
      {/* Background + Hero-like gradient */}
      <div
        className="absolute inset-0 bg-cover bg-center"
        style={{
          backgroundImage:
            "linear-gradient(110deg, rgba(2,6,23,0.94) 30%, rgba(15,23,42,0.92) 70%), url('/Images/Hero.jpg')",
        }}
      />
